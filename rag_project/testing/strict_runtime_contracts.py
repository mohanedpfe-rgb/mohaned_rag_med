...
def install() -> None:
    ...
    runner.phase15_resource_stability = strict_resource_stability; runner.UnifiedDiagnosticEngine._execute.__globals__["phase15_resource_stability"] = strict_resource_stability; runner.UnifiedDiagnosticEngine._execute.__globals__["metamorphic"] = run_full_metamorphic_suite; runner.UnifiedDiagnosticEngine._execute.__globals__["_hardened_mutation_phase"] = run_full_mutation_suite; runner._hardened_mutation_phase = run_full_mutation_suite
    ...
    if original_phase17 is not None and not getattr(original_phase17, "_provenance_wrapped", False):
        ...
        wrapped_phase17._provenance_wrapped = True; runner.UnifiedDiagnosticEngine._execute.__globals__["phase17_strict_completion"] = wrapped_phase17
