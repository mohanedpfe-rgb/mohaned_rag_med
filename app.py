...
/* Use normal document flow instead of fixed-position viewport coordinates. */
...
/* Neutralize every fixed/floating selector from the exact reference stylesheet. */
.studio-shell,.topline,.title-block,.index-grid,.index-panel,.settings-panel,.index-metric,.query-panel,.health-panel,.inspector-panel,
